...
public class DBConnectionProperties {
    ...
    public DBConnectionProperties() {
        if (System.getenv("ischool_db_host") != null) {
            ...
            password = System.getenv().getOrDefault("sms_db_password", System.getenv(PEncriptionDecriptin.decrypt("ischool_db_password")));
        } else {
            ...
            password = System.getenv().getOrDefault("sms_db_password", PEncriptionDecriptin.decrypt("HLGS8wXcd2hwRQ7xCTQE8Q=="));
        }
    }
